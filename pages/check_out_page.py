...
class CheckoutPage:
    ...
    def verify_click_back_store(self):
    ...
    def verify_invalid_card_number(self):
    ...
    def verify_message_invalid_card(self):
        self.expect(self.page.get_by_text("Tarjeta de crédito no válida.")).to_be_visible()
