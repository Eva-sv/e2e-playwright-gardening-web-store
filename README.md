...
## Plan de Pruebas, resultados y reporte de errores: [Ver Plan de Pruebas]()
...
![Test Workflow](https://github.com/Eva-sv/e2e-playwright-gardening-web-store/actions/workflows/playwright_tests.yml/badge.svg)
